...
//            assertEquals("jwt-token-123", loginResponse.getAccessToken());
...
//            when(loginService.profile(userLoginDetails, token)).thenReturn(profileResponse);
//            when(httpServletRequest.getHeader(any())).thenReturn("Bearer ABC_TOKEN");
//
//            // Act
//            ResponseEntity<?> response = loginController.profile(userLoginDetails, httpServletRequest);
//
//            // Assert
//            assertEquals(HttpStatus.OK, response.getStatusCode());
//            assertNotNull(response.getBody());
...
//            verify(loginService, times(1)).profile(userLoginDetails, token);
//        }
//
//        @Test
...
//            assertTrue(result.getPermissions().contains("USER_READ"));
//            assertTrue(result.getPermissions().contains("CLIENT_DELETE"));
//            verify(loginService, times(1)).profile(userLoginDetails, token);
//        }
//
//        @Test
...
//
//            // Act
//            ResponseEntity<?> response = loginController.profile(null, httpServletRequest);
//
//            // Assert
//            assertEquals(HttpStatus.OK, response.getStatusCode());
//        }
